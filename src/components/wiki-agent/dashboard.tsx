    ...
    return (
        <div className="flex h-screen overflow-hidden w-full bg-slate-50 dark:bg-slate-950">
            ...
            <SidebarInset className="flex w-full flex-col overflow-hidden bg-transparent">
                <header className="flex h-14 shrink-0 items-center justify-between border-b bg-white dark:bg-slate-900 px-4 transition-all">
                        ...
                        <Sheet>
                            ...
                            <SheetContent side="right">
                                ...
                                <div className="py-4 flex flex-col gap-2">
                                    ...
                                    <Button variant="outline" className="w-full justify-start" onClick={() => document.getElementById("settings-tab")?.click()}>Settings</Button>
                                </div>
                            </SheetContent>
                        </Sheet>
                    </div>
                ...
                <main className="flex-1 w-full p-4 overflow-y-auto">
                    <div className="mx-auto w-full max-w-6xl space-y-4">
                        ...
                        <Alert variant="default" className="bg-sky-50 text-sky-900 border-sky-200 dark:bg-sky-950 dark:text-sky-200 dark:border-sky-800">
                        ...
                        <Tabs defaultValue="chat" className="w-full">
                            <div className="flex w-full items-center justify-between mb-4">
                                <div>
                                    <h1 className="text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Workspace</h1>
                                    <p className="text-sm text-slate-500 dark:text-slate-400">Manage your AI interactions and preferences.</p>
                                </div>
                                <TabsList>
